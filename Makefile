...
pagerank_standard:
	rm -rf ./out/pagerank/
	spark-submit spark/jobs/pagerank.py --gzip --edges /cosr/back/out/d2dgraph/edges/ --vertices /cosr/back/out/d2dgraph/vertices/ --dump /cosr/back/out/pagerank/ --maxiter 100 --shuffle_partitions 10
	@echo ""
	@echo "Top 10 domains:"
